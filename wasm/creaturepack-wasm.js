...
var TOTAL_MEMORY = Module['TOTAL_MEMORY'] || 524288000;
...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'creaturepack-wasm.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'creaturepack-wasm.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'creaturepack-wasm.temp.asm.js';
...
STATICTOP = STATIC_BASE + 28560;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__I_000101() } }, { func: function() { __GLOBAL__sub_I_CreaturePackManager_cpp() } }, { func: function() { __GLOBAL__sub_I_bind_cpp() } }, { func: function() { __GLOBAL__sub_I_iostream_cpp() } });


memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "creaturepack-wasm.html.mem" : null;




var STATIC_BUMP = 28560;
...
// {{PRE_LIBRARY}}
  ...
  var tupleRegistrations={};function __embind_register_value_array_element(
      rawTupleType,
      getterReturnType,
      getterSignature,
      getter,
...
Module['wasmTableSize'] = 692;

Module['wasmMaxTableSize'] = 692;
...
var __GLOBAL__sub_I_CreaturePackManager_cpp = Module["__GLOBAL__sub_I_CreaturePackManager_cpp"] = function() {  return Module["asm"]["__GLOBAL__sub_I_CreaturePackManager_cpp"].apply(null, arguments) };
...
var dynCall_iiiiif = Module["dynCall_iiiiif"] = function() {  return Module["asm"]["dynCall_iiiiif"].apply(null, arguments) };
